    ...
    <div id="app">
        ...
        <div class="main-menu">
            ...
            <div class="navigation">
                ...
                <ul class="menu js__accordion " >
                    ...
                    <li class="tab">
                        <a class="waves-effect" href="{{route('admin.news')}}"><i class="menu-icon fa fa-newspaper-o"></i><span>News</span></a>
                    </li>
                    <li class="tab">
                        <a class="waves-effect" href="{{route('admin.category')}}"><i class="menu-icon fa fa-tasks"></i><span>Category</span></a>
                    </li>
        ...
        <div class="fixed-navbar">
            ...
            <div class="pull-right">
                ...
                <a class="ico-item mdi mdi-logout js__logout" href="{{ route('admin.logout') }}"
